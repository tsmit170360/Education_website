<?php
        ...
        $insert_query_registration_individual = "insert into registration_individual (f_name, l_name, username, password) VALUES ('". $registration_data['f_name'] ."','". $registration_data['l_name'] ."','". $registration_data['u_name'] ."','". $registration_data['u_pass'] ."')";
